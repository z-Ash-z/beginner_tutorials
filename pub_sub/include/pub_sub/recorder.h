...
class Recorder : public rclcpp::Node {
    ...
    protected:
        rclcpp::Subscription<std_msgs::msg::String>::SharedPtr subscription_;   //!< The pointer to the subscriber.
        std::unique_ptr<rosbag2_cpp::Writer> writer_;   //!< The pointer to the ros bag writer.
         ...
         */
        virtual void recorder_callback(std::shared_ptr<rclcpp::SerializedMessage> msg); 
